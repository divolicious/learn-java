...
<head>
    ...
    <title>Roro Jonggrang Story - Learn Java by Stories</title>
...
<body>
    ...
    <div class="story-container">
        <a href="../users/beginner_stories.php" class="back-btn">← Back to Stories</a>
        
        <div class="story-header">
            <h1 class="story-title">Roro Jonggrang</h1>
            <img src="../img/roro_jonggrangcomic.png" alt="Sangkuriang Story" class="story-image">
        </div>
