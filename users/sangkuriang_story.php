...
<head>
    ...
    <title>Sangkuriang Story - Learn Java by Stories</title>
...
<body>
    ...
    <div class="story-container">
        <a href="beginner_stories.php" class="back-btn">← Back to Stories</a>
        
        <div class="story-header">
            <h1 class="story-title">Sangkuriang</h1>
            <img src="../img/Sangkuriang_comic_illust.png" alt="Sangkuriang Story" class="story-image">
        </div>
